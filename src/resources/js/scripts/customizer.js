...
$(document).ready(function () {
    function getCustomizerOption() {
        if (localStorage.getItem('theme.menu-color-option') !== null) {
            var menuColorOption = localStorage.getItem('theme.menu-color-option');
            $(`.menu-color-option[data-color='${menuColorOption}']`).click()
        }

        if (localStorage.getItem('theme.menu-dark-checkbox') !== null) {
            var menuDarkCheckbox = localStorage.getItem('theme.menu-dark-checkbox');
            menuDark(JSON.parse(menuDarkCheckbox));
            console.log('menuDarkCheckbox: ' + menuDarkCheckbox)
        }


        if (localStorage.getItem('theme.menu-collapsed-checkbox') !== null) {
            var menuCollapsedCheckbox = localStorage.getItem('theme.menu-collapsed-checkbox');
            menuCollapsed(JSON.parse(menuCollapsedCheckbox));
            console.log('menuCollapsedCheckbox: ' + menuDarkCheckbox)
        }

        if (localStorage.getItem('theme.menu-selection-radio') !== null) {
            var menuSelectionRadio = localStorage.getItem('theme.menu-selection-radio');
            menuSelection(menuSelectionRadio);
            console.log('menuSelectionRadio: ' + menuSelectionRadio)
        }

        if (localStorage.getItem('theme.navbar-color-option') !== null) {
            var navbarColorOption = localStorage.getItem('theme.navbar-color-option');
            $(`.navbar-color-option[data-color='${navbarColorOption}']`).click()

            console.log('navbarColorOption: ' + navbarColorOption)
        }

        if (localStorage.getItem('theme.navbar-dark-checkbox') !== null) {
            var navbarDarkCheckbox = localStorage.getItem('theme.navbar-dark-checkbox');
            navbarDark(JSON.parse(navbarDarkCheckbox));
            console.log('navbarDarkCheckbox: ' + navbarDarkCheckbox)
        }else if (localStorage.getItem('theme.menu-dark-checkbox') !== null) {
            menuDark(JSON.parse(menuDarkCheckbox));
        }
    ...
    $(".menu-color-option, .menu-bg-color-option").click(function (e) {
        ...
        localStorage.setItem('theme.menu-color-option', menu_color);
    });

    //Set menu dark/light
    $(".menu-dark-checkbox").click(function (e) {
        let isDark = false;
        isDark = !!$(".menu-dark-checkbox").prop("checked");
        menuDark(isDark);
        localStorage.setItem('theme.menu-dark-checkbox', isDark);
    ...
    $(".menu-selection-radio").click(function (e) {
        ...
        localStorage.setItem('theme.menu-selection-radio', menu_selection);
    ...
    $(".menu-collapsed-checkbox").click(function (e) {
        ...
        localStorage.setItem('theme.menu-collapsed-checkbox', isCollapsed);
    });
    ...
    function menuCollapsed(isCollapsed) {
        if (isCollapsed) {
            $(".menu-collapsed-checkbox").prop("checked", true);
            ...
            $(".menu-collapsed-checkbox").prop("checked", false);
            $(".sidenav-main")
                .addClass("nav-lock")
    ...
    function menuSelection(menu_selection) {
        $(`.menu-selection-radio[value='${menu_selection}']`).prop("checked", true);
        $(".sidenav-main")
    ...
    $(".navbar-color-option").click(function (e) {
        ...
        localStorage.setItem('theme.navbar-color-option', navbar_color);
    ...
    $(".navbar-dark-checkbox").click(function (e) {
        let isDark = false;
        isDark = !!$(".navbar-dark-checkbox").prop("checked");
        navbarDark(isDark);
        localStorage.setItem('theme.navbar-dark-checkbox', isDark);
