$(document).ready(function () {
    ...
    $(".snow-container .compose-editor").each(function () {
        // console.log()
        var composeMailEditor = new Quill(this, {
            modules: {
                toolbar: $('.compose-quill-toolbar')[$(this).data('index')]
            },
    ...
    $(".email-compose-sidebar .cancel-email-item, .email-compose-sidebar .close-icon, .email-compose-sidebar .send-email-item, .email-overlay").on("click", function () {
