                        ...
                        if (data.listItems[i].name) {
                            if (
                                ...
                                $startList +=
                                    ...
                                    $activeItemClass +
                                    '">' +
                                    '<a class="collection-item" href="' + data.listItems[i].url + '">' +
                                        '<div class="display-flex">' +
                                            '<div class="display-flex align-item-center flex-grow-1">' +
                                                '<span class="material-icons" data-icon="' + data.listItems[i].icon + '">' + data.listItems[i].icon + "</span>" +
                                                    '<div class="member-info display-flex flex-column">' +
                                                '<span class="black-text">' + data.listItems[i].name + '</span>' +
                                    ((data.listItems[i].category)?'<small class="grey-text">' + data.listItems[i].category + "</small>":'') +
                                            "</div>" +
                                        "</div>" +
                                        "</div>" +
                                    "</a>" +
                                    "</li>";
                                if (data.listItems[i].submenu){
                                    for (var j = 0; j < data.listItems[i].submenu.length; j++) {
                                        $startList +=
                                            '<li class="auto-suggestion ' +
                                            $activeItemClass +
                                            '">' +
                                            '<a class="collection-item" href="' + data.listItems[i].submenu[j].url + '">' +
                                            '<div class="display-flex">' +
                                            '<div class="display-flex align-item-center flex-grow-1">' +
                                            '<span class="material-icons" data-icon="' + data.listItems[i].icon + '">' + data.listItems[i].icon + "</span>" +
                                            '<div class="member-info display-flex flex-column">' +
                                            '<span class="black-text">' + data.listItems[i].submenu[j].name + '</span>' +
                                            '<small class="grey-text">' + data.listItems[i].name + "</small>" +
                                            "</div>" +
                                            "</div>" +
                                            "</div>" +
                                            "</a>" +
